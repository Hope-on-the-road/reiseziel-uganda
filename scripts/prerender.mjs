...
const ROUTES = [
  ...
  '/grossraubtiere-uganda',
  '/loewen-queen-elizabeth-murchison',
  '/gorilla-permit-preise',
  '/ugandische-rolex',
  '/nachhaltiger-tourismus-uganda-tipps',
  '/gesundheitssystem-kampala',
  '/ranger-sicherheit-gorilla-trekking',
  '/gorilla-trekking-vorbereitung',
  '/bwindi-vs-andere-nationalparks',
  '/bwindi-trekking-anfaenger',
  '/sicherheit-rwampara-uganda',
  '/reisefreiheit-uganda-regionen',
  '/bedrohte-tierarten-uganda',
  '/quelle-nil-jinja',
  '/landwirtschaft-wakiso-uganda',
  '/grossraubtier-schutz-ziele-uganda',
  '/mensch-tier-konflikt-uganda',
  ...
  '/natureuganda-mission',
  '/sporenkiebitz-uganda',
  '/prinia-arten-uganda',
  '/stare-uganda-arten',
  '/kabale-kisoro-vogelbeobachtung',
  '/roller-eisvoegel-uganda',
  '/kiebitz-arten-uganda',
  '/lake-mburo-vogelbeobachtung',
  '/vogelbeobachtung-anfaenger-uganda',
  '/kormoran-uganda',
  '/echuya-forest-reserve',
  '/kasese-vogelbeobachtung',
  '/naturschutz-institutionen-uganda',
  '/lake-kasyoha-kitomi-voegel',
  '/pauschalreisen-uganda',
...
async function renderRoute(browser, route, counters) {
  try {
    ...
    // Warten bis Head.jsx / HomeSeo.jsx das data-page-ready-Attribut gesetzt hat
    // (signalisiert: React gerendert + alle SEO-useEffects abgeschlossen)
    await page.waitForSelector('[data-page-ready]', { timeout: 8000 }).catch(() => {})
