    ...
    <div className="min-h-screen">
      ...
      <RouteErrorBoundary>
        ...
        <Routes>
          ...
          <Route path="/nordwesten-ugandas-murchison-falls" element={<StandalonePage photos={photos} clusters={clusters} pageId="nordwesten-ugandas-murchison-falls" />} />
          <Route path="/durch-laender-fliesst-nil" element={<StandalonePage photos={photos} clusters={clusters} pageId="durch-laender-fliesst-nil" />} />
          ...
          <Route path="/wasser-sanitaer-hygiene-kampala" element={<StandalonePage photos={photos} clusters={clusters} pageId="wasser-sanitaer-hygiene-kampala" />} />
          <Route path="/strassenbeleuchtung-kampala" element={<StandalonePage photos={photos} clusters={clusters} pageId="strassenbeleuchtung-kampala" />} />
