...
export function usePhotosByCluster(photos) {
  return useMemo(() => {
    ...
    return {
      ...
      strassen: match(i => i.category === 'Roads & Transport' || i.category === 'Infrastructure'),
      maerkte: match(i => i.category === 'Markets & Local Business' || all(i).includes('markt') || all(i).includes('market')),
      ...
      essen: match(i => i.category === 'Food & Cooking' || i.category === 'Food' || i.category === 'HopeKitchen' || all(i).includes('banana')),
