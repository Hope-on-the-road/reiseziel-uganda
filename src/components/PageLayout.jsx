  ...
  return (
    <section id="faq" className="mt-16 sm:mt-24 scroll-mt-24">
      <div className="flex items-center gap-4 mb-8 sm:mb-10">
        <div className="hidden sm:block h-px flex-1 bg-gradient-to-r from-transparent to-gray-200" />
        <h2 className="font-display text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 shrink-0">
          Haeufig gestellte Fragen
        </h2>
        <div className="hidden sm:block h-px flex-1 bg-gradient-to-l from-transparent to-gray-200" />
      </div>
