...
const LINK_RULES = [
  ...
  { pattern: /Murchison[\s-]Treehouse/gi, path: '/lodges-murchison-falls' },
  { pattern: /Fort[\s-]Murchison/gi, path: '/lodges-murchison-falls' },
  { pattern: /Sambiya[\s-]River[\s-]Lodge/gi, path: '/lodges-murchison-falls' },
  ...
  { pattern: /HopeKitchen/gi, path: '/nachhaltiger-tourismus-uganda' },
  { pattern: /Duerre.*Uganda|Uganda.*Duerre/gi, path: '/duerre-armut-uganda' },
  { pattern: /Klimawandel.*Armut|Armut.*Klimawandel/gi, path: '/duerre-armut-uganda' },
  { pattern: /NSOER\s+2024/gi, path: '/duerre-armut-uganda' },
  { pattern: /Bwindi.*Artenvielfalt|Artenvielfalt.*Bwindi/gi, path: '/bwindi-artenvielfalt' },
  { pattern: /357\s+Vogelarten/gi, path: '/bwindi-artenvielfalt' },
  { pattern: /Aardvark\s+Lodge/gi, path: '/bwindi-artenvielfalt' },
  { pattern: /Ngamba\s+Island/gi, path: '/umweltaudit-uganda' },
  { pattern: /Environmental\s+Compliance\s+Audit/gi, path: '/umweltaudit-uganda' },
  { pattern: /Umwelt-Compliance-Audit/gi, path: '/umweltaudit-uganda' },
  { pattern: /\bNEMA\b(?!\s+Uganda\s+\w)/gi, path: '/nema-umweltschutz-uganda' },
  { pattern: /National\s+Environment\s+Management\s+Authority/gi, path: '/nema-umweltschutz-uganda' },
  { pattern: /Lead\s+Agenc(?:y|ies)/gi, path: '/nema-umweltschutz-uganda' },
  { pattern: /Umweltpetition|Umweltbeschwerde/gi, path: '/nema-umweltschutz-uganda' },
  { pattern: /Jinja.*Sehensw[uü]rdigkeiten|Sehensw[uü]rdigkeiten.*Jinja/gi, path: '/jinja-sehenswuerdigkeiten' },
  { pattern: /Nil-Quelle\b/gi, path: '/jinja-sehenswuerdigkeiten' },
  { pattern: /Bujagali/gi, path: '/jinja-sehenswuerdigkeiten' },
  { pattern: /Wildwasser-Rafting\s+(?:auf\s+dem\s+Nil|Jinja|Uganda)/gi, path: '/jinja-sehenswuerdigkeiten' },
  ...
  { pattern: /Hauptstadt\s+Ugandas/gi, path: '/kampala' },
  { pattern: /Kampala\s+Capital\s+City/gi, path: '/kampala' },
  { pattern: /Kasubi-Graeberstaette|Kasubi\s+Tombs/gi, path: '/kampala' },
  { pattern: /nachhaltigen?\s+Tourismus/gi, path: '/nachhaltiger-tourismus-uganda' },
  { pattern: /Abfallwirtschaft\s+Uganda/gi, path: '/nachhaltiger-tourismus-uganda' },
